<x-app-layout>
    ...
    <div class="container-draft">
        ...
        <table border="1" class="border text-center">
            ...
            @foreach ($recent['recent'] as $r) {{-- {{dd($r)}} --}}
            <tr>
                ...
                <td class="py-5 px-3 border-2 border-collapse">
                    <div class="{{$r->request_status === 'accepted' ? 'bg-green-600' : ( $r->request_status === 'rejected' ? 'bg-red-500' : 'bg-gray-500' )}} p-2 rounded-lg text-white font-bold">
                        {{$r->request_status}}
                    </div>
                </td>
                <td class="py-5 px-3 border-2 border-collapse">
